...
public class SecondReactActivity extends Activity implements DefaultHardwareBackBtnHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mReactRootView.startReactApplication(mReactInstanceManager, "SecondReactActivity", null);
